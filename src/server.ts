  ...
  let server = createServer({
    ...
    seeds(server) {
      ...
      server.create("van", {
        ...
        price: 178,
        description:
          "The Mt. Maverick is built for those who want to push their limits and explore the wildest terrain. With off-road suspension, heavy-duty tires, and a high-clearance design, this van can handle rugged mountain trails and rough dirt roads. Inside, you’ll find a comfy bed, a compact kitchen with everything you need to cook on the go, and ample storage space for all your gear. Whether you’re climbing peaks or exploring hidden valleys, the Mountain Maverick will be your trusty companion on every adventure.",
